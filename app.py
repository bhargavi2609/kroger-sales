...
# app.config.update(dict(PREFERRED_URL_SCHEME = 'http'))

config = {
    'host': 'cloudproject2023.mysql.database.azure.com',
    'user': 'bhargavi',
    'password': 'Cloud@2023',
    'database': 'temp',
...
def homepage():
    ...
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form:
        ...
        if user:
            ...
            return redirect(get_http_url('profile'))
        else:
...
def profile():
    ...
    return redirect(get_http_url('homepage'))
